...
public class AutoInsuranceProduct extends AbstractInsuranceProduct {

    public AutoInsuranceProduct(String category, BigDecimal iof, BigDecimal pis, BigDecimal cofins) {
