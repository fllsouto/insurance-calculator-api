...
public class PrivateInsuranceProduct extends AbstractInsuranceProduct {

    public PrivateInsuranceProduct(String category, BigDecimal iof, BigDecimal pis, BigDecimal cofins) {
